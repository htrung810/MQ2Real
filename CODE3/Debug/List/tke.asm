...
_0x4:
	...
	.DB  0x36,0x30,0x30
_0x5:
	.DB  0x41,0x54,0x26,0x57
_0x6:
	.DB  0x41,0x54,0x2B,0x43,0x4D,0x47,0x46,0x3D
	.DB  0x31
_0x7:
	.DB  0x41,0x54,0x2B,0x43,0x4D,0x47,0x53,0x3D
	.DB  0x22,0x2B,0x38,0x34,0x39,0x33,0x36,0x32
	.DB  0x33,0x30,0x38,0x36,0x31,0x22
_0x8:
	.DB  0x57,0x61,0x72,0x6E,0x69,0x6E,0x67,0x20
	.DB  0x6D,0x6F,0x76,0x65
_0x0:
	.DB  0x4C,0x4F,0x41,0x44,0x49,0x4E,0x47,0x20
	.DB  0x53,0x49,0x4D,0x2E,0x2E,0x2E,0x0,0x20
	.DB  0x54,0x48,0x4F,0x41,0x54,0x20,0x48,0x49
	.DB  0x45,0x4D,0x20,0x4E,0x47,0x41,0x59,0x0
	.DB  0x50,0x48,0x41,0x54,0x20,0x48,0x49,0x45
	.DB  0x4E,0x20,0x4C,0x55,0x41,0x0,0x43,0x4F
	.DB  0x20,0x43,0x48,0x41,0x59,0x20,0x52,0x4F
	.DB  0x49,0x0,0x50,0x48,0x41,0x54,0x20,0x48
	.DB  0x49,0x45,0x4E,0x0,0x4B,0x48,0x49,0x20
	.DB  0x47,0x41,0x0,0x41,0x4E,0x20,0x54,0x4F
	.DB  0x41,0x4E,0x0
_0x2020003:
	.DB  0x80,0xC0
...
_0xD:
	LDI  R26,LOW(_cmd_baud)
	LDI  R27,HIGH(_cmd_baud)
	CALL SUBOPT_0x0
	BREQ _0xE
;    {
;        UDR = cmd_baud[i];
...
_0x10:
	LDI  R26,LOW(_cmd_setup)
	LDI  R27,HIGH(_cmd_setup)
	CALL SUBOPT_0x0
	BREQ _0x11
;    {
;        UDR = cmd_setup[i];
...
; 0000 0021 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 0022 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=P Bit1=P Bit0=P
; 0000 0023 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(7)
	OUT  0x1B,R30
; 0000 0024 
...
; 0000 002D DDRC=(0<<DDC7) | (1<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(64)
	OUT  0x14,R30
...
; 0000 0071 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0072 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 0073 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 0074 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 0075 UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 0076 
...
; 0000 008F // RS - PORTA Bit 5
; 0000 0090 // RD - PORTA Bit 6
; 0000 0091 // EN - PORTA Bit 7
; 0000 0092 // D4 - PORTC Bit 0
; 0000 0093 // D5 - PORTC Bit 1
; 0000 0094 // D6 - PORTC Bit 2
; 0000 0095 // D7 - PORTC Bit 3
; 0000 0096 // Characters/line: 16
; 0000 0097 lcd_init(16);
	LDI  R26,LOW(16)
	CALL _lcd_init
; 0000 0098 lcd_puts("LOADING SIM...");
	__POINTW2MN _0x1B,0
	CALL _lcd_puts
; 0000 0099 delay_ms(15000);
	LDI  R26,LOW(15000)
	LDI  R27,HIGH(15000)
	CALL _delay_ms
; 0000 009A sim_status();
	RCALL _sim_status
...
_0x1C:
; 0000 009F       {
; 0000 00A0         if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0)
	SBIC 0x19,0
	RJMP _0x20
	SBIC 0x19,1
	RJMP _0x20
...
_0x21:
; 0000 00A1         {
; 0000 00A2             lcd_puts(" THOAT HIEM NGAY");
	__POINTW2MN _0x1B,15
	CALL _lcd_puts
; 0000 00A3             PORTC.6 = 1;
	SBI  0x15,6
; 0000 00A4             sim_sendmess();
	RCALL _sim_sendmess
; 0000 00A5             while (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0){}
_0x24:
	SBIC 0x19,0
	RJMP _0x27
	SBIC 0x19,1
...
_0x26:
; 0000 00A6         }
; 0000 00A7         else if(PINA.2 == 0)
	RJMP _0x29
_0x1F:
	SBIC 0x19,2
	RJMP _0x2A
; 0000 00A8         {
; 0000 00A9             lcd_puts("PHAT HIEN LUA");
	__POINTW2MN _0x1B,32
	CALL _lcd_puts
; 0000 00AA             PORTC.6 = 1;
	SBI  0x15,6
; 0000 00AB             while (PINA.2 == 0)
_0x2D:
	SBIC 0x19,2
	RJMP _0x2F
; 0000 00AC             {
; 0000 00AD                 if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {break;}
	SBIC 0x19,0
	RJMP _0x31
	SBIC 0x19,1
	RJMP _0x31
...
_0x2F:
; 0000 00AF         }
; 0000 00B0         else if (PINA.1 == 0)
	RJMP _0x33
_0x2A:
	SBIC 0x19,1
	RJMP _0x34
; 0000 00B1         {
; 0000 00B2             lcd_puts("CO CHAY ROI");
	__POINTW2MN _0x1B,46
	CALL _lcd_puts
; 0000 00B3             PORTC.6 = 1;
	SBI  0x15,6
; 0000 00B4             while (PINA.1 == 0){
_0x37:
	SBIC 0x19,1
	RJMP _0x39
; 0000 00B5                 if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {break;}
	SBIC 0x19,0
	RJMP _0x3B
	SBIC 0x19,1
	RJMP _0x3B
...
_0x39:
; 0000 00B7         }
; 0000 00B8         else if (PINA.0 == 0)
	RJMP _0x3D
_0x34:
	SBIC 0x19,0
	RJMP _0x3E
; 0000 00B9         {
; 0000 00BA             lcd_puts("PHAT HIEN");
	__POINTW2MN _0x1B,58
	CALL _lcd_puts
; 0000 00BB             lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 00BC             lcd_puts("KHI GA");
	__POINTW2MN _0x1B,68
	CALL _lcd_puts
; 0000 00BD             PORTC.6 = 1;
	SBI  0x15,6
; 0000 00BE             while (PINA.0 == 0)
_0x41:
	SBIC 0x19,0
	RJMP _0x43
; 0000 00BF             {
; 0000 00C0                 if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {break;}
	SBIC 0x19,0
	RJMP _0x45
	SBIC 0x19,1
	RJMP _0x45
...
_0x3E:
; 0000 00C4         {
; 0000 00C5             lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00C6             lcd_puts("AN TOAN");
	__POINTW2MN _0x1B,75
	CALL _lcd_puts
; 0000 00C7             PORTC.6 = 0;
	CBI  0x15,6
; 0000 00C8         }
