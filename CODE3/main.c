...
DDRC=(0<<DDC7) | (1<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
...
while (1)
      {
        if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0)
        {   
            lcd_puts(" THOAT HIEM NGAY");
            PORTC.6 = 1;
            sim_sendmess();
        ...
        {
            lcd_puts("PHAT HIEN LUA");
            PORTC.6 = 1;
            while (PINA.2 == 0)
            {
                if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {break;}
            }
        }                 
        else if (PINA.1 == 0)
        {
            lcd_puts("CO CHAY ROI");
            PORTC.6 = 1;
            while (PINA.1 == 0){
                if (PINA.0 == 0 && PINA.1 == 0 && PINA.2 == 0) {break;}
            }
